...
public class SolicitudCompra implements Calculable {
    ...
    public SolicitudCompra(int id, String departamento, EstadoSolicitud solicitada, List<DetalleCompra> productos) {
    }
    public SolicitudCompra(int id, String departamento, EstadoSolicitud estado) {
        this.id = id;
